...
interface PlayerStoreState {
  ...
  createCharacter: (name: string, characterData?: Partial<CharacterState>) => string;
  updateCharacter: (characterId: string, updates: Partial<PlayerCharacter>) => void;
  updateCharacterData: (characterId: string, characterData: CharacterState) => void;
  ...
  importCharacter: (data: CharacterState | CharacterExport, name?: string) => string;
...
const createPlayerCharacter = (name: string, characterData: CharacterState): PlayerCharacter => {
  const now = new Date();
  return {
    id: generateId(),
    name,
