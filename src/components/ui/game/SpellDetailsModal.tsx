  ...
  return (
    ...
    >
      <DialogContent size="lg">
        <DialogHeader>
          <DialogTitle className="sr-only">Spell Details</DialogTitle>
        </DialogHeader>
        <DialogBody>
          {/* Header */}
                ...
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  {spell.ritual && (
                    <Badge variant="warning" size="sm">
                      <AppIcon name="ritual" className="h-3.5 w-3.5" /> Ritual
                    </Badge>
                  )}
                  {spell.concentration && (
                    <Badge variant="warning" size="sm">
        ...
        <DialogFooter className="border-divider bg-surface-secondary -m-6 mt-6 border-t-2 p-4">
