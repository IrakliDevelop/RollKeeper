        ...
        {Object.keys(itemsByLocation).length > 0 ? (
          <div className="space-y-6">
            {Object.entries(itemsByLocation).map(([location, items]) => (
              <div key={location} className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-200 p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-sm text-purple-600">
                    <span className="mr-4">Weight: {getTotalWeight(items).toFixed(1)} lbs</span>
...
function ItemCard({ item, onEdit, onDelete, onQuantityChange }: ItemCardProps) {
  ...
  return (
    <div className="p-3 border border-gray-200 rounded-lg bg-white hover:border-gray-300 transition-all shadow-sm">
