...
export interface RawMonsterData {
    ...
    size?: string;
    type?: string | { type: string, tags: string[] };
    alignment?: (string | { alignment: string, chance?: number, entry?: string })[];
    ac?: (number | { ac: number, from: string[] })[];
    hp?: { average: number, formula: string };
    speed?: { [key: string]: number | boolean | { number: number, condition: string } };
    str?: number;
    dex?: number;
    con?: number;
    int?: number;
    ...
    resist?: (string | { resist: (string | { resist: string[], note: string })[]; note: string } | { special: string })[];
    immune?: (string | { immune: string[]; note: string } | { special: string })[];
    vulnerable?: (string | { vulnerable: string[]; note: string } | { special: string })[];
    senses?: unknown[];
    passive?: number;
    languages?: string[];
    cr?: unknown;
