...
export interface IntentBusDeps {
  ...
  /** Highest contiguously applied seq for a sender tab (persisted watermark). */
  getWatermark: (tabId: string) => number;
...
export class CharacterIntentBus {
  ...
  /** Leader-side out-of-order holding pen, keyed by sender tabId. */
