...
import {
  callEncounterRpc,
  createEncounterUserClient,
} from '@/lib/supabase/encounterServer';
...
export async function POST(request: NextRequest) {
  ...
  const client = await createEncounterUserClient();
  ...
  try {
    ...
    switch (body.action) {
      ...
      case 'confirm-cutover':
        name = 'confirm_encounter_cutover';
        args = {
          p_mutation_id: body.mutationId,
          p_run_id: body.runId,
          p_manifest_fingerprint: body.manifestFingerprint,
      ...
      case 'put':
        ...
        break;
      case 'history':
        name = 'list_encounter_document_versions';
        args = { p_campaign_id: body.campaignId, p_legacy_id: body.legacyId };
        break;
      case 'export-version':
        name = 'export_encounter_document_version';
        args = {
          p_campaign_id: body.campaignId,
          p_legacy_id: body.legacyId,
      ...
      case 'compare-versions':
        name = 'compare_encounter_document_versions';
        args = {
          p_campaign_id: body.campaignId,
          p_legacy_id: body.legacyId,
      ...
      case 'restore-version':
        name = 'restore_encounter_document_version';
        args = {
          p_mutation_id: body.mutationId,
          p_campaign_id: body.campaignId,
          p_expected_epoch: body.expectedEpoch,
      ...
      case 'preview-enrollment':
        name = 'preview_encounter_device_enrollment';
        args = { p_campaign_id: body.campaignId };
        break;
      case 'enroll-device':
        name = 'enroll_encounter_device';
        args = {
          p_mutation_id: body.mutationId,
          p_campaign_id: body.campaignId,
          p_device_id: body.deviceId,
      ...
      case 'remove-device':
        ...
        break;
      case 'rollback':
        name = 'rollback_encounter_family';
        args = {
          p_mutation_id: body.mutationId,
          p_campaign_id: body.campaignId,
          p_expected_epoch: body.expectedEpoch,
    ...
    const data = await callEncounterRpc(client, name, args);
    ...
    return NextResponse.json(
      {
        error:
          code === '40001'
            ? 'Encounters changed; refresh and reconcile.'
            : 'Encounter request was denied.',
      },
      {
