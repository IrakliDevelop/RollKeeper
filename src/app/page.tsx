...
export default function CharacterSheet() {
  ...
  // State for experimental features section
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-slate-200 p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Link 
                href="/spellbook"
                className="relative flex items-center gap-2 px-4 py-2 text-sm bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:via-violet-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg transform hover:scale-105 border border-purple-400/30"
                title="Experimental Spellbook - Advanced spell management with filters, search, and personal grimoire"
              >
                <Book size={16} />
                  ...
                  <div>
                    ...
                    {!experimentalFeaturesExpanded && (
                      <p className="text-sm text-gray-600 mt-1">
                        Advanced Spellbook with 540+ D&D spells, filters & more...
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mb-4 leading-relaxed">
                        Discover our new comprehensive spellbook feature with <strong>540+ D&D spells</strong>, 
                        advanced filtering, personal grimoire management, and infinite scroll. Perfect for 
                        spellcasters who want full control over their magical arsenal!
                      </p>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        <span className="bg-violet-100 text-violet-800 px-3 py-1 rounded-full text-sm font-medium border border-violet-200">
                          📚 Personal Spellbook
                        </span>
                      ...
                      <Link 
                        href="/spellbook"
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 text-white px-6 py-3 rounded-lg hover:from-purple-700 hover:via-violet-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg transform hover:scale-105 font-medium"
                      >
                        <Book size={20} />
                        Explore Spellbook
