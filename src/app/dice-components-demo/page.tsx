            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <DiceButton
                  notation="1d20+5"
                  variant="danger"
                  onRollComplete={handleRollResult}
                >
                  Sword Attack (+5)
                </DiceButton>
                <DiceButton
        ...
        <section className="rounded-lg bg-white p-6 shadow">
          ...
          <div className="space-y-4">
            <div>
              ...
              <pre className="overflow-x-auto rounded bg-gray-100 p-4 text-sm text-black">
                {`<DiceButton 
  notation="1d20+5" 
  variant="danger"
  ...
  Roll Attack
        ...
        <section className="rounded-lg border border-blue-200 bg-blue-50 p-6">
          ...
          <ul className="space-y-2 text-blue-700">
            ...
            <li>
              • Use <code>DiceButton</code> for simple integration into existing
              UI
            </li>
            <li>
              • Use <code>DiceRoller</code> for complete dice rolling interfaces
            </li>
            <li>
              • Use <code>useSimpleDiceRoll</code> hook for custom
              implementations
            </li>
