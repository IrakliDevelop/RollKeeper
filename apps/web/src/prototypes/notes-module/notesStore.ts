...
export interface ProtoNotesStore {
  ...
  // Actions
  createNote: (
    note: Omit<ProtoNote, 'id' | 'createdAt' | 'updatedAt' | 'excerpt'>
  ) => string;
            ...
            note.id === id
              ? {
                  ...
                  excerpt: updates.content
                    ? generateExcerpt(updates.content)
                    : note.excerpt,
  ...
  const sampleNotes = [
    {
      ...
      content:
        '<h1>The Adventure Begins</h1><p>Our party discovered a mysterious cave entrance while traveling through the <strong>Whispering Woods</strong>. Strange sounds echoed from within.</p><ul><li>Found goblin tracks leading inside</li><li>Ysara detected magical aura</li><li>Decision to investigate tomorrow</li></ul>',
      category: 'session',
    ...
    },
    {
      ...
      content:
        "<h2>Thorin Ironbeard</h2><p><em>Dwarf Blacksmith, Age 142</em></p><p>A gruff but kind-hearted blacksmith in the village of <strong>Millbrook</strong>. He's been crafting weapons for 80 years and knows every adventurer who's passed through.</p><h3>Key Info:</h3><ul><li>Lost his son to orc raiders 20 years ago</li><li>Offers 20% discount to those who help villagers</li><li>Knows secret passages in the old mine</li></ul>",
      category: 'npc',
    ...
    },
    {
      ...
      content:
        "<h2>Ring of Minor Telepathy</h2><p><strong>Wondrous item, uncommon (requires attunement)</strong></p><p>While wearing this ring, you can communicate telepathically with any creature within 30 feet of you that shares a language with you.</p><h3>Properties:</h3><ul><li>Range: 30 feet</li><li>Duration: Concentration, up to 10 minutes</li><li>Uses: 3 times per long rest</li></ul><p><em>Found in the goblin shaman's treasure chest.</em></p>",
      category: 'item',
    ...
    },
    {
      ...
      content:
        '<h1>The Shadow Cult Investigation</h1><p>Growing evidence suggests a cult is operating in the region:</p><h2>Evidence Found:</h2><ul><li>Strange symbols carved in trees near Millbrook</li><li>Villagers report nightmares of hooded figures</li><li>Animals found drained of blood with no wounds</li><li>Merchant caravans going missing on the North Road</li></ul><h2>Leads to Follow:</h2><ol><li>Investigate the old temple ruins north of town</li><li>Question the hermit who lives by Crystalfall Lake</li><li>Research shadow magic in the town library</li></ol>',
      category: 'plot',
