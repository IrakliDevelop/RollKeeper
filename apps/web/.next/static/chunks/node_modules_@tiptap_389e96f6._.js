...
var Bold = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].create({
    ...
    renderMarkdown: (node, h)=>{
        return "**".concat(h.renderChildren(node), "**");
    },
    addCommands () {
        return {
            setBold: ()=>(param)=>{
...
var Code = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].create({
    ...
    renderMarkdown: (node, h)=>{
        ...
        return "`".concat(h.renderChildren(node.content), "`");
    },
    addCommands () {
        return {
            setCode: ()=>(param)=>{
...
var Heading = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    ...
    renderMarkdown: (node, h)=>{
        ...
        return "".concat(headingChars, " ").concat(h.renderChildren(node.content));
    },
    addCommands () {
        return {
        ...
        return {
            setHorizontalRule: ()=>(param)=>{
                    ...
                    return currentChain.command((param)=>{
                        let { state: chainState, tr, dispatch } = param;
                        if (dispatch) {
    ...
    while(currentLineIndex < lines.length){
        ...
        while(nextLineIndex < lines.length){
            ...
            if (nextLine.trim() === "") {
                ...
                itemLines.push(nextLine);
                itemContent += "\n".concat(nextLine.slice(indentLevel + 2));
                nextLineIndex += 1;
            } else {
                break;
            }
...
var TaskItem = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    ...
    renderMarkdown: (node, h)=>{
        ...
        const prefix = "- [".concat(checkedChar, "] ");
...
var Underline = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].create({
    ...
    renderMarkdown (node, helpers) {
        return "++".concat(helpers.renderChildren(node), "++");
    },
    markdownTokenizer: {
        name: "underline",
        level: "inline",
...
var findChildSpans = function(element) {
...
var mergeNestedSpanStyles = (element)=>{
    ...
    childSpans.forEach((childSpan)=>{
        ...
        childSpan.setAttribute("style", "".concat(closestParentSpanStyleOfChild, ";").concat(childStyle));
    });
};
var TextStyle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].create({
    ...
    addCommands () {
        return {
            toggleTextStyle: (attributes)=>(param)=>{
                    let { commands } = param;
                    return commands.toggleMark(this.name, attributes);
                },
            removeEmptyTextStyle: ()=>(param)=>{
                    let { tr } = param;
                    const { selection } = tr;
...
var BackgroundColor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
    ...
    addCommands () {
        return {
            setBackgroundColor: (backgroundColor)=>(param)=>{
                    let { chain } = param;
                    return chain().setMark("textStyle", {
                        backgroundColor
                    }).run();
                },
            unsetBackgroundColor: ()=>(param)=>{
                    let { chain } = param;
                    return chain().setMark("textStyle", {
...
var FontFamily = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
                ...
                attributes: {
                    fontFamily: {
                        ...
                        renderHTML: (attributes)=>{
                            ...
                            return {
                                style: "font-family: ".concat(attributes.fontFamily)
                            };
                        }
                    }
                }
    ...
    addCommands () {
        return {
            setFontFamily: (fontFamily)=>(param)=>{
                    let { chain } = param;
                    return chain().setMark("textStyle", {
                        fontFamily
                    }).run();
                },
            unsetFontFamily: ()=>(param)=>{
                    let { chain } = param;
                    return chain().setMark("textStyle", {
                        fontFamily: null
                    }).removeEmptyTextStyle().run();
...
var LineHeight = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
                ...
                attributes: {
                    lineHeight: {
                        ...
                        renderHTML: (attributes)=>{
                            ...
                            return {
                                style: "line-height: ".concat(attributes.lineHeight)
                            };
                        }
                    }
                }
    ...
    addCommands () {
        return {
            setLineHeight: (lineHeight)=>(param)=>{
                    let { chain } = param;
                    return chain().setMark("textStyle", {
                        lineHeight
                    }).run();
                },
            unsetLineHeight: ()=>(param)=>{
                    let { chain } = param;
                    return chain().setMark("textStyle", {
                        lineHeight: null
                    }).removeEmptyTextStyle().run();
...
//# sourceMappingURL=node_modules_%40tiptap_389e96f6._.js.map