...
"[project]/apps/web/src/utils/calculations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getProficiencyBonus = (level)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFICIENCY_BONUS_BY_LEVEL"][clampedLevel] || 2;
};
const calculateSkillModifier = (character, skillName)=>{
    const skill = character.skills[skillName];
    const relatedAbility = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SKILL_ABILITY_MAP"][skillName];
...
const calculateTotalArmorClass = function(baseAC, tempAC, isWearingShield) {
    let shieldBonus = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 2;
...
const calculateHitPointMaximum = function(character) {
    let hitDieType = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 8 // Default d8, could be passed from class data
    ;
...
const getWeaponAttackString = (character, weapon)=>{
    ...
    return "".concat(formatModifier(attackBonus), " to hit");
};
const getWeaponDamageString = function(character, weapon) {
    let versatile = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    ...
    if (!Array.isArray(weapon.damage)) {
        ...
        if (legacyDamage && legacyDamage.dice && legacyDamage.type) {
            ...
            if (damageBonus === 0) {
                return "".concat(dice, " ").concat(legacyDamage.type);
            }
            return "".concat(dice).concat(formatModifier(damageBonus), " ").concat(legacyDamage.type);
        }
        return 'No damage';
    }
    ...
    const damageStrings = weapon.damage.map((damage, index)=>{
        ...
        if (bonus === 0) {
            return "".concat(dice, " ").concat(damage.type);
        }
        return "".concat(dice).concat(formatModifier(bonus), " ").concat(damage.type);
    });
    return damageStrings.join(', ');
};
const rollDamage = function(dice) {
    let bonus = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
    ...
    // Format result
    if (numDice === 1) {
        return "".concat(total).concat(diceBonus + bonus !== 0 ? " (".concat(rolls[0]).concat(diceBonus + bonus > 0 ? "+".concat(diceBonus + bonus) : diceBonus + bonus, ")") : '');
    } else {
        return "".concat(total, " (").concat(rolls.join('+')).concat(diceBonus + bonus !== 0 ? "".concat(diceBonus + bonus > 0 ? "+".concat(diceBonus + bonus) : diceBonus + bonus) : '', ")");
    }
};
function calculateSpellSlots(classInfo, level) {
    ...
    switch(classInfo.spellcaster){
        case 'full':
            slotsTable = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FULL_CASTER_SPELL_SLOTS"];
            break;
        case 'half':
            slotsTable = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HALF_CASTER_SPELL_SLOTS"];
            break;
        case 'third':
            slotsTable = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THIRD_CASTER_SPELL_SLOTS"];
            break;
        default:
            return emptySlots;
    }
...
function calculatePactMagic(level) {
    const pactData = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WARLOCK_PACT_SLOTS"][level];
...
function calculateLevelFromXP(xp) {
    ...
    for(let level = 20; level >= 1; level--){
        if (xp >= __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP_THRESHOLDS"][level]) {
            return level;
        }
    }
...
function getXPForLevel(level) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP_THRESHOLDS"][Math.max(1, Math.min(20, level))] || 0;
}
...
function getSpellAttackString(character) {
    ...
    return attackBonus >= 0 ? "+".concat(attackBonus) : "".concat(attackBonus);
}
...
function calculateMulticlassSpellSlots(classes) {
    ...
    const levelSlots = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FULL_CASTER_SPELL_SLOTS"][casterLevel] || {};
    const result = {
        1: {
            max: 0,
            used: 0
...
function calculateCharacterHitDicePools(character) {
    ...
    if (character.classes && character.classes.length > 0) {
        ...
        for (const classInfo of character.classes){
            const dieType = "d".concat(classInfo.hitDie);
    ...
    // Fallback to single class calculation
    const dieType = "d".concat(character.class.hitDie);
    return {
        [dieType]: {
            max: character.level,
            used: 0
...
"[project]/apps/web/src/utils/multiclass.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function migrateToMulticlass(character) {
    var _character_class, _character_class1, _character_class2, _character_class3;
    ...
    const singleClass = {
        className: ((_character_class = character.class) === null || _character_class === void 0 ? void 0 : _character_class.name) || '',
        level: character.level || 1,
        isCustom: ((_character_class1 = character.class) === null || _character_class1 === void 0 ? void 0 : _character_class1.isCustom) || false,
        spellcaster: (_character_class2 = character.class) === null || _character_class2 === void 0 ? void 0 : _character_class2.spellcaster,
        hitDie: ((_character_class3 = character.class) === null || _character_class3 === void 0 ? void 0 : _character_class3.hitDie) || 8
    };
    // Calculate hit dice pools from single class
    const hitDicePools = {};
    const dieType = "d".concat(singleClass.hitDie);
    hitDicePools[dieType] = {
...
function calculateHitDicePools(classes, existingPools) {
    ...
    classes.forEach((cls)=>{
        const dieType = "d".concat(cls.hitDie);
        if (!hitDicePools[dieType]) {
            hitDicePools[dieType] = {
                max: 0,
                used: 0
...
function calculateMulticlassSpellSlots(classes) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$calculations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateSpellSlots"])(dummyClassInfo, casterLevel);
}
...
function validateMulticlassRequirements(currentClasses, newClassName, abilities, classData) {
    var _newClassData_multiclassing, _newClassData_spellcasting;
    const errors = [];
    const warnings = [];
    // Try to get requirements from API data first, then fallback to hardcoded
    let newClassRequirements = {};
    const newClassData = classData === null || classData === void 0 ? void 0 : classData.find((cls)=>cls.name === newClassName);
    if ((newClassData === null || newClassData === void 0 ? void 0 : (_newClassData_multiclassing = newClassData.multiclassing) === null || _newClassData_multiclassing === void 0 ? void 0 : _newClassData_multiclassing.requirements) && Object.keys(newClassData.multiclassing.requirements).length > 0) {
        ...
        if (Object.keys(newClassRequirements).length === 0) {
            errors.push("Multiclassing requirements not found for ".concat(newClassName));
            return {
                valid: false,
                errors,
                warnings
    ...
    for (const [ability, requiredScore] of Object.entries(newClassRequirements)){
        ...
        if (abilityScore < requiredScore) {
            errors.push("".concat(newClassName, " requires ").concat(ability.charAt(0).toUpperCase() + ability.slice(1), " ").concat(requiredScore, " (you have ").concat(abilityScore, ")"));
        }
    }
    // Check requirements for existing classes (must maintain them)
    for (const existingClass of currentClasses){
        var _existingClassData_multiclassing;
        let existingClassRequirements = {};
        const existingClassData = classData === null || classData === void 0 ? void 0 : classData.find((cls)=>cls.name === existingClass.className);
        if ((existingClassData === null || existingClassData === void 0 ? void 0 : (_existingClassData_multiclassing = existingClassData.multiclassing) === null || _existingClassData_multiclassing === void 0 ? void 0 : _existingClassData_multiclassing.requirements) && Object.keys(existingClassData.multiclassing.requirements).length > 0) {
        ...
        for (const [ability, requiredScore] of Object.entries(existingClassRequirements)){
            const abilityScore = abilities[ability];
            if (abilityScore < requiredScore) {
                errors.push("You must maintain ".concat(ability.charAt(0).toUpperCase() + ability.slice(1), " ").concat(requiredScore, " for ").concat(existingClass.className, " (you have ").concat(abilityScore, ")"));
            }
        }
    }
    ...
    const newClassIsSpellcaster = (newClassData === null || newClassData === void 0 ? void 0 : (_newClassData_spellcasting = newClassData.spellcasting) === null || _newClassData_spellcasting === void 0 ? void 0 : _newClassData_spellcasting.type) && newClassData.spellcasting.type !== 'none';
...
function addClassLevel(character, className) {
    let isCustom = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, spellcaster = arguments.length > 3 ? arguments[3] : void 0, hitDie = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 8, subclass = arguments.length > 5 ? arguments[5] : void 0;
...
"[project]/apps/web/src/utils/hpCalculations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function calculateMaxHP(classInfo, level, constitutionScore, manualOverride) {
    ...
    const conModifier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$calculations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateModifier"])(constitutionScore);
...
function getClassHitDie(className, customHitDie) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_HIT_DICE"][className] || 8; // Default to d8 for unknown classes
}
...
function makeDeathSave(hitPoints, isSuccess) {
    let isCritical = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
...
"[project]/apps/web/src/utils/currency.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function formatCurrencyFromCopper(totalCopper) {
    ...
    const parts = [];
    if (gold > 0) parts.push("".concat(gold, " gp"));
    if (silver > 0) parts.push("".concat(silver, " sp"));
    if (copper > 0) parts.push("".concat(copper, " cp"));
    return parts.join(', ');
}
function formatCurrencyFromCopperShort(totalCopper) {
    ...
    const copper = remainingAfterGold % 10;
    const parts = [];
    if (gold > 0) parts.push("".concat(gold, "g"));
    if (silver > 0) parts.push("".concat(silver, "s"));
    if (copper > 0) parts.push("".concat(copper, "c"));
    return parts.join(' ');
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/apps/web/src/utils/fileOperations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const exportCharacterToFile = (exportData)=>{
    ...
    const filename = "".concat(characterName.replace(/[^a-z0-9]/gi, '_').toLowerCase(), "_").concat(timestamp, ".json");
...
const importCharacterFromFile = ()=>{
    return new Promise((resolve, reject)=>{
        ...
        input.onchange = async (event)=>{
            var _files;
            const file = (_files = event.target.files) === null || _files === void 0 ? void 0 : _files[0];
            if (!file) {
            ...
            try {
                ...
                for (const prop of requiredProps){
                    if (!(prop in data.character)) {
                        reject(new Error("Missing required character property: ".concat(prop)));
                        return;
                    }
                }
                resolve(data);
...
"[project]/apps/web/src/utils/apiClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function apiRequest(url) {
    try {
        ...
        console.error("API request failed for ".concat(url, ":"), error);
        return {
...
async function fetchBestiary() {
    var _result_data;
    const result = await apiRequest("".concat(API_BASE, "/bestiary"));
    return ((_result_data = result.data) === null || _result_data === void 0 ? void 0 : _result_data.monsters) || [];
}
async function searchMonsters() {
    let query = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '', filters = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, limit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 20, offset = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
    var _filters_sizes, _filters_types, _filters_alignments, _filters_sources, _filters_crRange, _filters_crRange1, _result_data, _result_data1, _result_data2;
    ...
    if ((_filters_sizes = filters.sizes) === null || _filters_sizes === void 0 ? void 0 : _filters_sizes.length) params.set('sizes', filters.sizes.join(','));
    if ((_filters_types = filters.types) === null || _filters_types === void 0 ? void 0 : _filters_types.length) params.set('types', filters.types.join(','));
    if ((_filters_alignments = filters.alignments) === null || _filters_alignments === void 0 ? void 0 : _filters_alignments.length) params.set('alignments', filters.alignments.join(','));
    if ((_filters_sources = filters.sources) === null || _filters_sources === void 0 ? void 0 : _filters_sources.length) params.set('sources', filters.sources.join(','));
    if (((_filters_crRange = filters.crRange) === null || _filters_crRange === void 0 ? void 0 : _filters_crRange.min) !== undefined) params.set('crMin', filters.crRange.min.toString());
    if (((_filters_crRange1 = filters.crRange) === null || _filters_crRange1 === void 0 ? void 0 : _filters_crRange1.max) !== undefined) params.set('crMax', filters.crRange.max.toString());
    ...
    const result = await apiRequest("".concat(API_BASE, "/bestiary/search?").concat(params));
    return {
        monsters: ((_result_data = result.data) === null || _result_data === void 0 ? void 0 : _result_data.monsters) || [],
        total: ((_result_data1 = result.data) === null || _result_data1 === void 0 ? void 0 : _result_data1.total) || 0,
        hasMore: ((_result_data2 = result.data) === null || _result_data2 === void 0 ? void 0 : _result_data2.hasMore) || false
    };
}
async function fetchSpells() {
    var _result_data;
    const result = await apiRequest("".concat(API_BASE, "/spells"));
    return ((_result_data = result.data) === null || _result_data === void 0 ? void 0 : _result_data.spells) || [];
}
async function fetchClasses() {
    var _result_data;
    const result = await apiRequest("".concat(API_BASE, "/classes"));
    return ((_result_data = result.data) === null || _result_data === void 0 ? void 0 : _result_data.classes) || [];
}
...
"[project]/apps/web/src/utils/textFormatting.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/utils/conditionsDiseasesLoader.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function loadConditionsDiseasesFile() {
    ...
    if (!response.ok) {
        throw new Error("Failed to load conditions/diseases data: ".concat(response.statusText));
    }
 ...
 */ function generateId(name, source) {
    return "".concat(name.toLowerCase().replace(/[^a-z0-9]/g, '-'), "-").concat(source.toLowerCase());
}
/**
    ...
    const parseEntry = (entry)=>{
        ...
        try {
                ...
                const processedItems = entry.items.map((item)=>{
                    ...
                    if (item.type === 'item') {
                        if (item.name && item.entry) {
                            return "**".concat(item.name, "**: ").concat(item.entry);
                        }
                        if (item.name && item.entries) {
                            ...
                            return "**".concat(item.name, "**: ").concat(entriesText);
                        }
                        if (item.entries) {
                    ...
                    if (item.name) {
                        ...
                        return content ? "**".concat(item.name, "**: ").concat(content) : "**".concat(item.name, "**");
                    }
            ...
            if (entry.name && entry.entries) {
                const entriesText = entry.entries.map(parseEntry).filter(Boolean).join(' ');
                return "**".concat(entry.name, "**: ").concat(entriesText);
            }
 ...
 */ function processCondition(rawCondition) {
    ...
    const description = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$textFormatting$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processAndFormatDndText"])(parseEntries(rawCondition.entries));
 ...
 */ function processDisease(rawDisease) {
    ...
    const description = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$textFormatting$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processAndFormatDndText"])(rawDisease.entries.join('\n\n'));
    return {
        id,
 ...
 */ function processStatus(rawStatus) {
    ...
    const description = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$textFormatting$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processAndFormatDndText"])(parseEntries(rawStatus.entries));
    return {
        id,
        name: rawStatus.name,
...
async function loadAllConditions() {
    ...
    try {
        ...
        console.log("Loaded ".concat(cachedConditions.length, " conditions"));
        return cachedConditions;
    } catch (error) {
...
async function loadAllDiseases() {
    ...
    try {
        ...
        console.log("Loaded ".concat(cachedDiseases.length, " diseases"));
        return cachedDiseases;
    } catch (error) {
...
async function loadAllStatuses() {
    ...
    try {
        ...
        console.log("Loaded ".concat(cachedStatuses.length, " statuses"));
        return cachedStatuses;
    } catch (error) {
...
"[project]/apps/web/src/utils/diceUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseDiceNotation(notation) {
    ...
    if (!match) {
        throw new Error("Invalid dice notation: ".concat(notation));
    }
...
function formatDiceResults(summary) {
    ...
    if (modifier === 0) {
        return "".concat(notation, ": [").concat(diceStr, "] = ").concat(finalTotal);
    } else {
        const modStr = modifier > 0 ? "+".concat(modifier) : "".concat(modifier);
        return "".concat(notation, ": [").concat(diceStr, "] ").concat(modStr, " = ").concat(finalTotal);
    }
}
...
function autoClearDice(diceBox) {
    let delay = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3000, onClear = arguments.length > 2 ? arguments[2] : void 0;
    setTimeout(()=>{
        try {
...
"[project]/apps/web/src/utils/referenceParser.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseReferences(content) {
    ...
    while((match = referenceRegex.exec(content)) !== null){
        ...
        const name = ((_parts_ = parts[0]) === null || _parts_ === void 0 ? void 0 : _parts_.trim()) || '';
        const source = (_parts_1 = parts[1]) === null || _parts_1 === void 0 ? void 0 : _parts_1.trim();
 ...
 */ function parseScaledDamage(baseDamage, levelRange, extra) {
    ...
    return "".concat(baseDamage, " (+ ").concat(additionalPerLevel, " per level above ").concat(levelSuffix, ")");
}
/**
 * Get the ordinal suffix for a level number
 */ function getLevelSuffix(level) {
    if (level >= 11 && level <= 13) {
        return "".concat(level, "th");
    }
    const lastDigit = level % 10;
    switch(lastDigit){
        case 1:
            return "".concat(level, "st");
        case 2:
            return "".concat(level, "nd");
        case 3:
            return "".concat(level, "rd");
        default:
            return "".concat(level, "th");
    }
}
 ...
 */ function formatDisplayText(type, name, source, extra) {
    switch(type.toLowerCase()){
        ...
        case 'hit':
            return "+".concat(name);
        case 'h':
            return "Hit: ".concat(name);
        case 'dc':
            return "DC ".concat(name);
        case 'actsave':
            return "".concat(name.toUpperCase(), " save");
        case 'actsavefail':
 ...
 */ function parseExtraProperties(extra) {
    ...
    extra.forEach((prop, index)=>{
        if (prop.includes('=')) {
            ...
            properties["extra_".concat(index)] = prop.trim();
        }
    });
    return properties;
}
 ...
 */ function formatReferenceHtml(reference) {
    ...
    const title = reference.source ? "".concat(reference.displayText, " (").concat(reference.source, ")") : reference.displayText;
    return '<span class="'.concat(baseClasses, " ").concat(typeClasses, '" title="').concat(title, '">').concat(icon, " ").concat(reference.displayText, "</span>");
}
 ...
 */ function formatReferenceForEditor(reference) {
    ...
    return "<strong>".concat(reference.displayText, "</strong>");
}
function formatSpellDescriptionForEditor(content) {
    ...
    const wrappedParagraphs = paragraphs.map((para)=>{
        ...
        return "<p>".concat(trimmed.replace(/\n/g, '<br>'), "</p>");
    }).filter(Boolean);
...
"[project]/apps/web/src/utils/featureConversion.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$referenceParser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/utils/referenceParser.ts [app-client] (ecmascript)");
;
/**
...
function convertBackgroundFeatureToExtendedFeature(feature) {
    const formattedDescription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$referenceParser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpellDescriptionForEditor"])(feature.description);
    ...
    return {
        ...
        maxUses: (usageInfo === null || usageInfo === void 0 ? void 0 : usageInfo.maxUses) || 0,
        restType: (usageInfo === null || usageInfo === void 0 ? void 0 : usageInfo.restType) || 'long',
        isPassive: !usageInfo,
...
function convertFeatToExtendedFeature(feat) {
    const formattedDescription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$referenceParser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpellDescriptionForEditor"])(feat.description);
    ...
    if (feat.prerequisites.length > 0) {
        sourceDetail += " (Requires: ".concat(feat.prerequisites.join(', '), ")");
    }
    if (feat.abilityIncreases) {
        sourceDetail += " [".concat(feat.abilityIncreases, "]");
    }
    return {
        name: feat.name,
        description: formattedDescription,
...
function convertClassFeatureToExtendedFeature(feature) {
    ...
    const description = ((_feature_entries = feature.entries) === null || _feature_entries === void 0 ? void 0 : _feature_entries.join('\n\n')) || '';
    const formattedDescription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$referenceParser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpellDescriptionForEditor"])(description);
    const usageInfo = parseUsesFromDescription(description);
    const scalingInfo = detectProficiencyScaling(description);
    // Build source detail
    const sourceDetail = feature.isSubclassFeature && feature.subclassShortName ? "".concat(feature.subclassShortName, " Level ").concat(feature.level) : "".concat(feature.className, " Level ").concat(feature.level);
    return {
        name: feature.name,
        description: formattedDescription,
        sourceType: 'class',
...
function partialFeatureToFormData(partial) {
    var _partial_isPassive, _partial_scaleWithProficiency;
    return {
        name: partial.name || '',
        ...
        isPassive: (_partial_isPassive = partial.isPassive) !== null && _partial_isPassive !== void 0 ? _partial_isPassive : true,
        scaleWithProficiency: (_partial_scaleWithProficiency = partial.scaleWithProficiency) !== null && _partial_scaleWithProficiency !== void 0 ? _partial_scaleWithProficiency : false,
...
"[project]/apps/web/src/utils/spellConversion.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function inferActionType(spell) {
    ...
    const hasAttackTag = (_spell_tags = spell.tags) === null || _spell_tags === void 0 ? void 0 : _spell_tags.some((tag)=>attackTags.some((attackTag)=>tag.toLowerCase().includes(attackTag)));
    if (hasAttackTag) {
        return 'attack';
    }
...
function convertProcessedSpellToFormData(spell) {
    var _spell_damage, _spell_saves;
    ...
    const damageType = ((_spell_damage = spell.damage) === null || _spell_damage === void 0 ? void 0 : _spell_damage[0]) || '';
    // Get saving throw from spell metadata - more reliable!
    const savingThrow = ((_spell_saves = spell.saves) === null || _spell_saves === void 0 ? void 0 : _spell_saves[0]) || '';
    ...
    const formattedDescription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$referenceParser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpellDescriptionForEditor"])(spell.description);
    const formattedHigherLevel = spell.higherLevelDescription ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$utils$2f$referenceParser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpellDescriptionForEditor"])(spell.higherLevelDescription) : '';
    return {
        name: spell.name,
        level: spell.level,
...
function convertFormDataToSpell(formData, existingId) {
    ...
    return {
        id: existingId || "spell_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
        name: formData.name,
...
function searchSpells(spells, query) {
    ...
    return spells.filter((spell)=>{
        ...
        const descriptionLower = spell.description.toLowerCase();
        return nameLower.includes(queryLower) || schoolLower.includes(queryLower) || descriptionLower.includes(queryLower) || ((_spell_tags = spell.tags) === null || _spell_tags === void 0 ? void 0 : _spell_tags.some((tag)=>tag.toLowerCase().includes(queryLower)));
    }).sort((a, b)=>{
...
//# sourceMappingURL=apps_web_src_utils_108db94c._.js.map