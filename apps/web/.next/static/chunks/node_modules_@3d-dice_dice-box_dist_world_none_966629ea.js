...
"[project]/node_modules/@3d-dice/dice-box/dist/world.none.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$3d$2d$dice$2f$dice$2d$box$2f$dist$2f$Dice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@3d-dice/dice-box/dist/Dice.js [app-client] (ecmascript)");
...
class P {
    ...
    async handleAsleep(e) {
        var o, n;
        if (e.asleep = !0, await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$3d$2d$dice$2f$dice$2d$box$2f$dist$2f$Dice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["D"].getRollResult(e), e.d10Instance || e.dieParent) {
            if ((o = e == null ? void 0 : e.d10Instance) != null && o.asleep || (n = e == null ? void 0 : e.dieParent) != null && n.asleep) {
                const l1 = e.config.sides === 100 ? e : e.dieParent, r = e.config.sides === 10 ? e : e.d10Instance;
                r.value === 0 && l1.value === 0 ? l1.value = 100 : l1.value = l1.value + r.value, this.onRollResult({
                    rollId: l1.config.rollId,
                    value: l1.value
                });
            }
...
//# sourceMappingURL=node_modules_%403d-dice_dice-box_dist_world_none_966629ea.js.map