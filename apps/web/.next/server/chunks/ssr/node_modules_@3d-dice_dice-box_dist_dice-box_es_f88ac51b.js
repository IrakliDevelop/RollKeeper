module.exports = [
"[project]/node_modules/@3d-dice/dice-box/dist/dice-box.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const sl = {
    ...
    origin: "undefined" < "u" ? window.location.origin : "",
    suspendSimulation: !1
};
...
class vl {
    ...
    async init() {
        return W(this, y) ? v(this, E, Gl).call(this) : i(this, K, Promise.resolve()), await v(this, I, cl).call(this), this.resizeWorld(), W(this, u).onRollResult = (l)=>{
            ...
            d.rolls[b.rollId].value = l.value, X1.completedRolls++, X1.completedRolls == X1.rolls.length && X1.resolve(Object.values(X1.rolls).map(({ collectionId: G, id: J, meshName: R, ...N })=>N));
            ...
            X1.value = Z.value, X1.qty = Z.rollsArray.length, d.completedRolls == d.rolls.length && d.resolve(Object.values(d.rolls).map(({ id: N, ...L })=>L));
    ...
    async getThemeConfig(l) {
        ...
        let d = await fetch(`${b}/theme.config.json`).then((m)=>{
            ...
            } else throw new Error(`Unable to fetch config file for theme: '${l}'. Request rejected with status ${m.status}: ${m.statusText}`);
        }).catch((m)=>console.error(m));
        if (!d) throw new Error("No theme config data to work with.");
        let X1 = "default", Z = `${this.config.origin}${this.config.assetPath}themes/default/default.json`;
        if (d.hasOwnProperty("meshFile") && (X1 = d.meshFile.replace(/(.*)\..{2,4}$/, "$1"), Z = `${b}/${d.meshFile}`), !d.hasOwnProperty("diceAvailable")) throw new Error('A theme must indicate which dice are available by defining "diceAvailable".');
    ...
    roll(l, { theme: b = this.config.theme, themeColor: d = this.config.themeColor, newStartPoint: X1 = !0 } = {}) {
        this.clear();
        const Z = o(this, f)._++;
    ...
    add(l, { theme: b = this.config.theme, themeColor: d = this.config.themeColor, newStartPoint: X1 = !0 } = {}) {
        const Z = o(this, f)._++;
        this.rollCollectionData[Z] = new M({
            id: Z,
            notation: l,
    ...
    reroll(l, { remove: b = !1, hide: d = !1, newStartPoint: X1 = !0 } = {}) {
...
f = new WeakMap(), x = new WeakMap(), C = new WeakMap(), B = new WeakMap(), u = new WeakMap(), w = new WeakMap(), U = new WeakMap(), p = new WeakMap(), K = new WeakMap(), k = new WeakMap(), y = new WeakMap(), I = new WeakSet(), cl = async function() {
    ...
    if (W(this, y)) if ("OffscreenCanvas" in window && "transferControlToOffscreen" in this.canvas && this.config.offscreen) {
        const b = await __turbopack_context__.A("[project]/node_modules/@3d-dice/dice-box/dist/world.offscreen.js [app-ssr] (ecmascript, async loader)").then((d)=>d.default);
        i(this, u, new b({
            canvas: this.canvas,
            options: this.config,
            onInitComplete: l
        ...
        const b = await __turbopack_context__.A("[project]/node_modules/@3d-dice/dice-box/dist/world.onscreen.js [app-ssr] (ecmascript, async loader)").then((d)=>d.default);
        i(this, u, new b({
            canvas: this.canvas,
            options: this.config,
            onInitComplete: l
        ...
        const b = await __turbopack_context__.A("[project]/node_modules/@3d-dice/dice-box/dist/world.none.js [app-ssr] (ecmascript, async loader)").then((d)=>d.default);
        i(this, u, new b({
            canvas: this.canvas,
            options: this.config,
            onInitComplete: l
...
//# sourceMappingURL=node_modules_%403d-dice_dice-box_dist_dice-box_es_f88ac51b.js.map